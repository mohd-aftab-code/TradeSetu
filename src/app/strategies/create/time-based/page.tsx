          ...
          <div className="space-y-6">
            ...
            <div className="bg-gradient-to-r from-blue-500/10 to-cyan-500/10 rounded-2xl p-4 border border-blue-500/20">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <h4 className="text-white font-semibold">Standalone Time-Based Strategy Page</h4>
                  ...
                  <div>
                    ...
                    <div className="flex items-center space-x-2">
                      <input
                        ...
                        className="flex-1 p-2 bg-slate-700/50 border border-blue-500/50 rounded-lg text-white focus:ring-2 focus:ring-blue-400 focus:outline-none backdrop-blur-sm"
                        style={{
                          colorScheme: 'dark'
                        }}
                      />
